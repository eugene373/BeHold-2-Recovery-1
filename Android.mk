...
RECOVERY_VERSION := .....EB-Recovery RFS / Ext4 Lagfix Edition.....
...
include $(CLEAR_VARS)
LOCAL_MODULE := stl.format
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_ROOT_OUT)/sbin
LOCAL_SRC_FILES := stl.format
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := flash_kernel
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_ROOT_OUT)/sbin
LOCAL_SRC_FILES := flash_kernel
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := flash_recovery
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_ROOT_OUT)/sbin
LOCAL_SRC_FILES := flash_recovery
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := unlock_kernel
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_ROOT_OUT)/sbin
LOCAL_SRC_FILES := unlock_kernel
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE := unlock_recovery
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_RECOVERY_ROOT_OUT)/sbin
LOCAL_SRC_FILES := unlock_recovery
include $(BUILD_PREBUILT)
